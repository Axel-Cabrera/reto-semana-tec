...
st.title("Spark & streamlit Axel Cabrera A01738945")

st.header("spark-submit Job")

github_user  =  st.text_input('Github user', value='Axel-Cabrera')
github_repo  =  st.text_input('Github repo', value='reto-semana-tec')
